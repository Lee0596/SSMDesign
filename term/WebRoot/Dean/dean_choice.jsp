...
<div class="site-text" style="margin: 5%; display: none" id="window" >	
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="start" lay-verify="required" placeholder="yyyy">
      </div>
      <div class="layui-form-mid">-</div>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="end" lay-verify="required" placeholder="yyyy">
      </div>
    </div>
  </div>
  	<div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <select id="term" lay-verify="required">
   ...
   <label class="layui-form-label" style="width: 100px">${sessionScope.study.getStudyStatus()}</label>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">上课班级号</label>
    <div class="layui-input-block">
      <input type="text" id="classID"   lay-verify="required" placeholder="请输入上课班级号" autocomplete="off" class="layui-input">
    </div>
  </div>
...
<button class="layui-btn" id="insertChoice">添加上课班级</button>
<table class="layui-hide" id="choiceTable" lay-filter="choiceList"></table>
  </div>
...
layui.use(['form','layer','table'], function(){
          ...
          table.render({
            elem: '#choiceTable'  //绑定table id
            ,url:'selectChoiceBypage'  //数据请求路径
            ,method:'post'
            ,cellMinWidth: 100
            ,cols: [[
                  {field:'studyID', width:150, title: '开课班级号', sort: true}
                  ,{field:'classID', width:150, title: '上课班级号', sort: true}
                  ,{field:'termDate', width:150, title: '学年学期', sort: true}
            ]]
        	,text: {
          ...
          $("#insertChoice").click(function(){
        	  var insertChoiceLayer = layer.open({
    			  type: 1, 
    			  title:"添加上课班级",
    			  area:['60%','70%'],
    			  btn: ['确定', '取消'], 
    			  content: $("#window"),
     			      ...
     			      $.ajax({
     			         url:"<%=request.getContextPath() %>/Dean/addChoice",
     			         data:{
     			        	start:start,
     			        	end:end,
     			        	term:term,
          ...
          $("#back").click(function(){
        	  location.href="<%=request.getContextPath() %>/Dean/showStudy?couID=${sessionScope.cou.getCouID()}";  
          })
  });
</script>
